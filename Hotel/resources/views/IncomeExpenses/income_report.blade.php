...
@section('content')
  ...
  <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                     <h2><i class="fa fa-long-arrow-right"></i> Registro ingresos </h2>
                ...
                @endif
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{url('storeIncome')}}">

                     <div class="form-group">
                     {{csrf_field()}}
                        <label class="control-label col-md-3 col-sm-9 col-xs-1" for="last-name">Fecha<span class="required">*</span> 
                        </label>
                        <div class="col-md-3">                        
                          <div class="control-group">
                              <div class="col-md-17 xdisplay_inputx form-group has-feedback">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <input  class=" form-control col-md-7 col-xs-12"  required="required" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" id="sum"  maxlength="6" name="sum">
                      ...
                      <div class="form-group">
                        <div class="col-md-3 col-sm-6 col-xs-12 col-md-offset-3">
                         <button type="submit" class="btn btn-round btn btn-success">Guardar</button>
                          <a href="{{url('home')}}" type='button' value='Cerrar' class="btn btn-round tn btn-primary">Cerrar</a>
                        </div>
                      </div>
