  ...
  <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                @endif
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" action="{{url('updateInExpe', $id)}}">
                     <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          <input type="text" id="bill_num"  maxlength="9" value="{{$in_expen['id']}}"  name="bill_num" required="required"  class="form-control col-md-7 col-xs-12">
